...
//      return $renderer->render($data);
       $mediaType   =   empty($this->element['media']) ? 'image' : $this->element['media'];
       $json =   [
           'id'      =>  $this->id,
           'name'    =>  $this->name,
           'value'   =>  $this->value,
           'media'   =>  $mediaType,
           'ajax'    =>  JUri::root().'administrator/index.php?option=com_ajax&astroid=media&action=library&asset=com_templates',
