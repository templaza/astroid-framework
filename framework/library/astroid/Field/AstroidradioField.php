 ...
 * @since  11.1
 */
class AstroidradioField extends ListField {
   ...
   protected function getLayoutData() {
      ...
      $extraData = array(
          ...
          'ngShow' => Helper::replaceRelationshipOperators($this->element['ngShow']),
          'ngHide' => Helper::replaceRelationshipOperators($this->element['ngHide']),
          'ngRequired' => Helper::replaceRelationshipOperators($this->element['ngRequired']),
