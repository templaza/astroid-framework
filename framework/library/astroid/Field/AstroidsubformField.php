...
class AstroidsubformField extends FormField
{
    /**
     * The form field type.
     * @var    string
    ...
    protected function getInput()
    {
        ...
        $form_template['countLabel'] =   isset($this->element['count-label']) ? \Joomla\CMS\Language\Text::_((string) ($this->element['count-label'])) : '';
        $value = $this->value;
        if (empty($value)) {
            $options = [];
        } else {
