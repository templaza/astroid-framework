        ...
        <div>
            <div class="row row-cols-1 g-4">
                <div v-if="props.field.input.options.colorpicker">
                    <label class="form-label">{{ props.field.input.lang.font_color }}</label>
                    <div>
                ...
                <div v-if="props.field.input.options.stylepicker">
                    <label :for="props.field.input.id+`_font_style`" class="form-label">{{ props.field.input.lang.font_style }}</label>
                    <div>
