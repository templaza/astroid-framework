...
// Track the cursor position
	...
	$(document).ready(function (){
		$('body').append('<svg class="as-cursor" width="24" height="24" viewBox="0 0 24 24" data-scale-enter="2" data-opacity-enter=".8"><circle class="cursor__inner" cx="12" cy="12" r="6"></circle></svg>');
